...
## Where we're at — Horizons-UI — the app

The lifecycle root: nothing lives without it. **The home screen is done — do not touch it.** See AGENT-BRIEF.md before working the app repo.
