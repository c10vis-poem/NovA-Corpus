...
### WHAT
Repo bank, model registry, old repo research.

### WHERE
The index of what exists and where it lives.

### WHEN
Consulted before forking or adding anything, to avoid a seventh copy.

### WHY
60+ forks with no index is how the same repo got forked three times.

### HOW
One row per asset: what it is, where it is, why it's here.

---

## Delta

⬜ Not established. The live-code audit has not run — do not infer this.
