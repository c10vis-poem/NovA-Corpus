# CLAUDE.md — Vendor and research documentation
...
### WHO
Read by whoever needs the vendor detail. Nobody owns it.

### WHAT
QAIRT/HTP, Qwen models, Llama, Unsloth, Google dev docs, NPU research, proofs, fragmented-QAT.

### WHERE
Reference material. **Not project architecture** — it describes other people's systems.

### WHEN
On demand.

### WHY
Kept because the vendor detail is hard to re-find and easy to get wrong from memory.

### HOW
Domain subfolders; originals kept beside their cleaned `.md`.

---

## Delta

**Weight is an open question** — QAIRT PDFs run ~7 MB each. Git LFS or a separate repo is undecided.
