...
## Where we're at — Vendor and research documentation

QAIRT/HTP, Qwen, Llama, Unsloth, Google dev docs, NPU research, proofs. Reference material, not project architecture.
