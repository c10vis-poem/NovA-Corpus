...
### WHAT
The SKILL.md corpus, the construction guideline, the router.

### WHERE
Consumed by whichever harness is running.

### WHEN
At agent start.

### WHY
So capability is declared and versioned rather than re-explained every session.

### HOW
One folder per skill; the router maps them and how they relate.
