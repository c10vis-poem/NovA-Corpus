...
> Note (vault mirror): the referenced images under `home-redesign-img/` were
> NOT copied into this text-only vault mirror — image assets are out of scope
> for this pass. The image filenames referenced below are kept as pointers.
