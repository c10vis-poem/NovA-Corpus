...
## Where we're at — AESOP — memory protocol layer

OB1 (structural), mem0 (episodic), OmniRoute (gateway), reasoning-bank (pattern). The memory architecture the whole stack reads and writes through.
