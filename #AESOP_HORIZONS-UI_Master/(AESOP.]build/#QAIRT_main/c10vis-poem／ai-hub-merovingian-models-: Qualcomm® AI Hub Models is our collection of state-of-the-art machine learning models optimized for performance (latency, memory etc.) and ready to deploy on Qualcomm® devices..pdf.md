...
(pulled from the source doc by `.migrate/extract_images.py` -- Markdown conversion drops these; see `c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/`)

- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0015.jpg) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0020.jpg) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0026.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0028.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0030.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0031.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0127.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0128.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0130.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0131.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0137.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0138.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0139.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0140.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0146.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0147.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0148.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0149.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0155.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0156.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0157.png) -- embedded raster
- ![embedded raster](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/image-0158.png) -- embedded raster
- ![page 1 render (368 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-1-diagram.png) -- page 1 render (368 vector ops)
- ![page 2 render (128 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-2-diagram.png) -- page 2 render (128 vector ops)
- ![page 3 render (66 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-3-diagram.png) -- page 3 render (66 vector ops)
- ![page 4 render (312 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-4-diagram.png) -- page 4 render (312 vector ops)
- ![page 5 render (684 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-5-diagram.png) -- page 5 render (684 vector ops)
- ![page 6 render (678 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-6-diagram.png) -- page 6 render (678 vector ops)
- ![page 7 render (696 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-7-diagram.png) -- page 7 render (696 vector ops)
- ![page 8 render (686 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-8-diagram.png) -- page 8 render (686 vector ops)
- ![page 9 render (632 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-9-diagram.png) -- page 9 render (632 vector ops)
- ![page 10 render (664 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-10-diagram.png) -- page 10 render (664 vector ops)
- ![page 11 render (518 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-11-diagram.png) -- page 11 render (518 vector ops)
- ![page 12 render (14 vector ops)](c10vis-poem／ai-hub-merovingian-models-: Qualcomm® AI Hub Models is our collection of state-of-the-art machine learning models optimized for performance (latency, memory etc.) and ready to deploy on Qualcomm® devices..pdf_images/page-12-diagram.png) -- page 12 render (14 vector ops)
